...
function RobinBirdLogo({ className = "h-8 w-auto" }) {
  return (
    <svg
      viewBox="0 0 345 69"
      fill="none"
...
export default function App() {
  ...
  return (
    <div
      className="font-body min-h-screen text-slate-900 selection:bg-red-200"
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-40 bg-white/80 backdrop-blur-xl border-b border-slate-200/60">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        >
          <RobinBirdLogo className="h-8 w-auto" />
        </button>
        ...
        <div className="flex items-center gap-3">
          ...
          <PrimaryButton size="sm" onClick={() => setActiveTab("contacts")}>
            Запросить доступ
          </PrimaryButton>
        </div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="scroll-fade-in">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 mb-8 rounded-full border border-slate-200 bg-white/60 backdrop-blur">
            ...
            <h1 className="text-5xl lg:text-6xl xl:text-7xl leading-tight tracking-tight text-slate-900 mb-7">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 mb-12">
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl tracking-tight text-slate-900 leading-tight">
              Не сервис, а{" "}
    ...
    <section className="border-b border-slate-200/60">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl lg:text-4xl tracking-tight text-slate-900 max-w-2xl mx-auto leading-tight">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {metrics.map((m, i) => (
            ...
            >
              <div className="text-5xl lg:text-6xl tracking-tight mb-2 font-display">
                {m.value}
              </div>
    ...
    <section>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        <div className="flex gap-8">
          {/* Sidebar — fixed 250px */}
          <aside
            className="flex-shrink-0 sticky top-24 self-start space-y-7"
            style={{ width: 250 }}
          >
            <FilterGroup
              label="Категория"
          ...
          {/* Right column: search + chips + 3x3 model cards */}
          <main className="flex-1 min-w-0">
            ...
            {/* Chips row — capabilities (multi-select OR) */}
            ...
            {/* 3x3 grid of model cards */}
            {visibleModels.length === 0 ? (
              <div className="border border-dashed border-slate-300 rounded-xl p-16 text-center">
      ...
      <div className="border-t border-slate-200/60 bg-slate-50/40">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 py-20">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl lg:text-4xl tracking-tight text-slate-900 leading-tight mb-4">
              Стать автором{" "}
  ...
  return (
    <footer className="border-t border-slate-200/60 bg-white mt-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        ...
        {/* Three link columns — evenly distributed, tight gap */}
        <div className="grid grid-cols-3 gap-6 lg:gap-8 pb-12 border-b border-slate-200/60">
          <FooterColumn
            title="Продукт"
            items={[
              "Каталог моделей",
